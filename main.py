...
# Configuração de Caminhos Absolutos para o PWA
...
async def api_status():
    try:
        ...
        # LGPD: Seleciona apenas o estritamente necessário para o financeiro
        ...
        def contar_unidades_reais(df_subset):
            ...
            # Conta itens separados por vírgula na mesma célula
        ...
        # Geração dos Filtros Mensais para o Menu UX
